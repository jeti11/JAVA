...
public class TreeSetEx {
  public static void main(String[] args) {
    ...
    // headSet(데이터, 포함여부) : 입력값보다 낮은 값을 출력하고, 해당 객체를 포함할지 여부를 지정
    // tailSet(데이터, 포함여부) : 입력값보다 높은 값을 출력하고, 해당 객체를 포함할지 여부를 지정
    // subSet(시작, 시작포함, 종료, 종료포함) : 시작 범위와 종료 범위 사이의 데이터를 출력하고, 해당 객체를 포함할지 여부를 지정
