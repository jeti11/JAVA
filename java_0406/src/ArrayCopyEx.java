...
public class ArrayCopyEx {
  public static void main(String[] args) {
    ...
    // System.arraycopy() : System 클레스에서 지원하는 배열 복사 메소드
    // 사용법 :
    ...
    System.out.println("\n------- Arrays.copyOf() 사용 -------'\n");
    // Arrays.copyOf() : Arrays 클레스에서 지원하는 배열 복사 메소드, 원본 배열을 그대로 복사
    // Arrays.copyOfRange() : Arrays 클레스에서 지원하는 배열 복사 메소드, 원본에서 원하는 크기만큼만 복사
    // 사용법 :
    // 타겟배열 = Arrays.copyOf(원본배열, 크기);
    ...
    // Object.clone() : 자바의 최상위 클래스인 Object 클레스에서 제공하는 메소드
    // 사용법 :
    // 타겟 배열 = 원본배열.clone();
